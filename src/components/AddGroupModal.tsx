        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="ex: Inteligência Artificial, Finanças..."
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Descreva brevemente qual o objetivo de curadoria deste grupo de vídeos..."
              rows={3}
